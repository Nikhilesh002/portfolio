      ...
      <div className="flex flex-wrap">
        <div className="w-full lg:w-1/2 ">
          <div className="pt-16 flex flex-col justify-center items-center ">
            ...
            <div className="mt-16">
              <a href={import.meta.env.VITE_RESUME} target="__blank" className="text-white bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-lg text-xl px-5 py-2.5 text-center me-2 mb-2">
